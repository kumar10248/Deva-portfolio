...
<CodeWindow title="Install Next.js">
```bash
...
<CodeWindow title="Install Tailwind CSS">
```bash
...
<CodeWindow title="styles/styles.css">
```css
@tailwind base;
@tailwind components;
@tailwind utilities;
...
<CodeWindow title="pages/index.js - State Management">
```jsx
...
<CodeWindow title="pages/index.js - localStorage Persistence">
```jsx
...
<CodeWindow title="styles/styles.css - Button Animation">
```css
@tailwind base;
@tailwind components;
@tailwind utilities;
...
<CodeWindow title="styles/styles.css - Media Query">
```css
@tailwind base;
@tailwind components;
@tailwind utilities;
